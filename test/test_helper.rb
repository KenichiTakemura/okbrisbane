...
class ActiveSupport::TestCase
  ...
  def load_system_config
    Rails.logger.debug("Loading System config")
    ss = SystemSetting.new
    ss.post_expiry_length = 30
    ss.socialable = true
    ss.issue_report_to = "ktakemur@localhost.com"
    ss.admin_email = "ktakemur@localhost.com"
    ss.contact_email = "ktakemur@localhost.com"
